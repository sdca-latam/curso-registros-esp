...
en las instructivas. Si no tendrás que actualizar las instalaciones.

::: panel-tabset
## Windows

1.  [R](https://cloud.r-project.org/bin/windows/base/): Cualquier Any
    version above {{< meta versions.r >}}. If you have used R before,
