# Instalación de los programas {#sec-installing-programs}
...
2.  [RStudio](https://www.rstudio.com/products/rstudio/download/#download):
    Cualquier versión mas reciente que {{< meta versions.rstudio >}}. If
...
1.  [R](https://cloud.r-project.org/bin/macosx/): Any version above
    ...
    the version by running `R.version.string` in the Console. If you use
    [Homebrew](https://brew.sh/) (which we strongly recommend installing
    and using), installing R is as easy as opening a Terminal and
    running:
