# Installing the programs {#sec-installing-programs}
...
1.  [R](https://cloud.r-project.org/bin/windows/base/): Any version
    above {{< meta versions.r >}}. If you have used R before, you can confirm
    the version by running `R.version.string` in the Console.

2.  [RStudio](https://www.rstudio.com/products/rstudio/download/#download):
    Any version above {{< meta versions.rstudio >}}. If
...
1.  [R](https://cloud.r-project.org/bin/macosx/): Any version above
    {{< meta versions.r >}}. If you have used R before, you can confirm the
    version by running `R.version.string` in the Console. If you use
    [Homebrew](https://brew.sh/) (which we strongly recommend installing and using),
    installing R is as easy as opening a Terminal and running:
...
2.  [RStudio](https://www.rstudio.com/products/rstudio/download/#download):
    Any version above {{< meta versions.rstudio >}}. If you have installed it
    before, check the current version by going to the menu "Help -> About
    RStudio". With Homebrew:
...
2.  [RStudio](https://www.rstudio.com/products/rstudio/download/#download):
    Any version above {{< meta versions.rstudio >}}. If you have installed it
    before, check the current version by going to the menu "Help -> About RStudio".
