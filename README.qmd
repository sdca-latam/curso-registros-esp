...
Este repositorio contiene los materiales para el curso "Introducción al
uso de registros nacionales de salud para investigación", que se llevará
a cabo el jueves 10 de septiembre 2026 en Lima, Perú.

Para mayor detalle, vea la [página de
bienvenida]({{< meta links.site >}}).
